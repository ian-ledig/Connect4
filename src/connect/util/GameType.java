...
public enum GameType {
    ...
    CONNECT4("ORIGINAL CONNECT 4", RuleConnect4.class), POPOUT("PopOut", RulePopOut.class), POP10("Pop 10", RulePopOut.class), POWERUP("Power Up", RulePopOut.class), INAROW5("5-in-a-Row", Rule5InARow.class), POPOUTINAROW5("PopOut & 5-in-a-row", RulePopOut5InARow.class);
